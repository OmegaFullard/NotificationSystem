<%@ Page Title="User Profile" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UserViewProfile.aspx.cs" Inherits="UserViewProfile" %>
              ...
              <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Email ID" TextMode="Password"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                     <div class="col-md-4">
                        <label>Pincode</label>
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox10" runat="server" placeholder="Pincode" TextMode="Password"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                              ...
                              <asp:Button class="btn btn-success btn-block btn-lg" ID="Button1" runat="server" Width="150px" Height="25px" style="color: #ffffff; background-color: #009900; border: medium solid #e6ffe6" Text="Go" />
                           <br />
                            </div>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        ...
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-success" runat="server" Width="150px" Height="25px" style="color: #ffffff; background-color: #009900; border: medium solid #ffffff" Text="Add" />

<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="ctrAgent.ascx.cs" Inherits="NotificationSystem.NotificationSystem.Web.ctrAgent" %>
...
<div style="width: 1200px; height:500px;  overflow: auto; padding-left:5px" >
           ...
           <asp:GridView ID="grdAgents" runat="server" 
                    ...
                    width="1200px" AllowPaging="True" AllowSorting="True" PageSize="9" OnPageIndexChanging="grdAgents_PageIndexChanging" OnSorting="grdAgents_Sorting">

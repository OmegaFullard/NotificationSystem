<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="ctrTroubleTicketReq.ascx.cs" Inherits="NotificationSystem.NotificationSystem.Web.ctrTroubleTicketReq" %>
...
<div style="width: 1200px; height:500px;  overflow: auto; padding-left:5px" >
    ...
    <br />
           ...
           <asp:GridView ID="grdTroubleTicketReq" runat="server" 
                    ...
                    width="1200px" AllowPaging="True" AllowSorting="True" PageSize="9" OnPageIndexChanging="grdTroubleTicketReq_PageIndexChanging" OnSorting="grdTroubleTicketReq_Sorting">

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrAdmin_Update.ascx.cs" Inherits="NotificationSystem.NotificationSystem.Web.Controls_Update.ctrAdmin_Update" %>

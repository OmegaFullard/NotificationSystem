<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="ctrSearch_Agent_Update.ascx.cs" Inherits="NotificationSystem.NotificationSystem.Web.Controls_Search.ctrSearch_Agent_Update" %>

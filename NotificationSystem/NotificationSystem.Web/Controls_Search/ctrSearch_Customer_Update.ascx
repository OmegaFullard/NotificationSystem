<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="ctrSearch_Customer_Update.ascx.cs" Inherits="NotificationSystem.NotificationSystem.Web.Controls_Search.ctrSearch_Customer_Update" %>

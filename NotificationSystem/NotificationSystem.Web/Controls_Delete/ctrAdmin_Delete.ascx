                             ...
                             <asp:Table ID="Table1" runat="server" Width="930px">
                                           ...
                                           <asp:TableRow> 
                                             ...
                                             <asp:TableCell HorizontalAlign="Left"> 
                                              &nbsp;&nbsp; <telerik:RadTextBox ID="txtfirstname" runat="server" Height="20px" Width="300px" TextMode="SingleLine"></telerik:RadTextBox>
                                          ...
                                          <asp:TableRow  > 
                                             ...
                                             <asp:TableRow>                     
                                                    ...
                                                    <asp:TableCell HorizontalAlign="Left">
                                                       &nbsp;&nbsp; <telerik:RadTextBox ID="txtusername" runat="server" Height="20px" Width="300px"  MaxLength="127"></telerik:RadTextBox>
                                                    </asp:TableCell>
                                             </asp:TableRow>
                                              <asp:TableRow  > 
                                                     <asp:TableCell HorizontalAlign="Right">&nbsp;&nbsp;</asp:TableCell>
                                             ...
                                             <asp:TableRow> 
                                                    ...
                                                    <asp:TableCell HorizontalAlign="Left">
                                                        &nbsp;&nbsp;<telerik:RadTextBox ID="txtpassword" runat="server" Height="20px" Width="300px"  MaxLength="127"></telerik:RadTextBox>     
                                                    </asp:TableCell>
                                                </asp:TableRow> 
                                   <asp:TableRow  > 
                                                     <asp:TableCell HorizontalAlign="Right">&nbsp;&nbsp;</asp:TableCell>

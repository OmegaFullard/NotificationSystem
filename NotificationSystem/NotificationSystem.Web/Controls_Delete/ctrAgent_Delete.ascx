<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="ctrAgent_Delete.ascx.cs" Inherits="NotificationSystem.NotificationSystem.Web.Controls_Delete.ctrAgent_Delete" %>

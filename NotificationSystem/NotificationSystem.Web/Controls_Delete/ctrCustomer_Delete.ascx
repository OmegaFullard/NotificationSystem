<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrCustomer_Delete.ascx.cs" Inherits="NotificationSystem.NotificationSystem.Web.Controls_Delete.ctrCustomer_Delete" %>

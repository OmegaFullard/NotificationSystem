<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrAdmin_Find.ascx.cs" Inherits="NotificationSystem.NotificationSystem.Web.Controls_Find.ctrAdmin_Find" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
 ...
 <div style="width: 1050px; height:800px;  overflow: auto; padding-left:30px" >
           ...
           <asp:GridView ID="grdAdmin" runat="server" 
                    ...
                    width="700px" AllowPaging="True" AllowSorting="True" PageSize="18" OnPageIndexChanging="grdAdmin_PageIndexChanging" OnSorting="grdAdmin_Sorting" OnLoad="Page_Load">

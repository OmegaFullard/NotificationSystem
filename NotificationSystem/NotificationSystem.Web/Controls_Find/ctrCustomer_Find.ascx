...
<div style="width: 1050px; height:800px;  overflow: auto; padding-left:30px" >
           ...
           <asp:GridView ID="grdCustomer" runat="server" 
                    ...
                    width="700px" AllowPaging="True" AllowSorting="True" PageSize="18" OnPageIndexChanging="grdCustomer_PageIndexChanging" OnSorting="grdCustomer_Sorting" OnLoad="Page_Load">

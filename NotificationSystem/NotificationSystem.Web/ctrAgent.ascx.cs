...
namespace NotificationSystem.NotificationSystem.Web
{
    public partial class ctrAgent : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (System.Web.UI.UserControl.Request.Form["ctl00$MainContent$ctrAgent_Search$btnSearch"] == "Search")
                    this.ctrHiddebField.Value = m_AgentID.Trim;

                if ((System.Web.UI.Control.Page.IsPostBack) & this.ctrHiddebField.Value.Length > 0)
                    tblAgent = theNotificationSystem.GetDepartmentsByName("%" + this.ctrHiddebField.Value + "%");
                else

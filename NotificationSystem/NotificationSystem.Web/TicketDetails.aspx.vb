...
Namespace NotificationSystem.NotificationSystem.Web
    ...
    Public Partial Class TicketDetails
        ...
        Protected ctrTroubleTicketReq_Find As NotificationSystem.NotificationSystem.Web.ctrTroubleTicketReq
            ...
            Try
                If MyBase.Page.IsPostBack Then
                    If Equals(Request.Form("ctl00$MainContent$ctrTroubleTicketReq_Search$btnSearch"), "Search") Then
                        ...
                        ctrTroubleTicketReq_Find.TroubleTicketNo = ctrTroubleTicketReq_Search.TroubleTicketNo
                    End If
                End If
